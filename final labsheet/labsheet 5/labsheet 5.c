...
void question1()
{
    ...
    {
        printf("\n");
        printf("%s	%d	%c", students[i].name, students[i].totalMarks, students[i].grade);
    }
}
...
void question2()
{
    ...
    printf("Name: %s Roll: %d Marks: %.2f Remarks: %s ", s.name, s.roll, s.marks, s.remarks);
}
...
void question3()
{
    ...
    for (i = 0; i < 5; i++)
    {
        ...
        {
            printf("Name: %s, Roll: %d", students[i].name, students[i].roll);
        }
    }
}
...
void question4()
{
    ...
    printf(" Employees in Ascending Order of Name: ");
    for (i = 0; i < 5; i++)
    {
        printf("\n");
        printf("Name: %s, Address: %s, Salary: %.2f ", employees[i].name, employees[i].address, employees[i].salary);
    }
}
...
void question5()
{
    ...
    for (i = 0; i < 5; i++)
    {
        printf("\nName: %s, Address: %s ", people[i].name, people[i].address);
    }
}
...
void question6()
{
    ...
    printf("Book Details: ");
    printf("Name: %s Pages: %d Price: %.2f ", ptr->name, ptr->pages, ptr->price);
}
...
void question7()
{
    ...
    printf("Name: %s Pages: %d Price: %.2f", books[maxIndex].name, books[maxIndex].pages, books[maxIndex].price);
}
...
void question10()
{
    ...
    printf("Date: %02d/%02d/%d", date.day, date.month, date.year);
}
...
void question11()
{
    ...
    printf("Username: %s ID Number: %s PIN: %d ", student.username, student.idNumber, student.pin);
}
...
void question12()
{
    ...
    printf(" Difference: %d Years, %d Months, %d Days", yearDiff, monthDiff, dayDiff);
}
...
void flightTime()
{
    ...
    printf("Enter details for 3 flights: ");
    for (i = 0; i < 3; i++)
    {
        printf("Flight %d: ", i + 1);
    ...
    for (i = 0; i < 3; i++)
    {
        printf("Flight Number: %d | Origin: %s | Destination: %s | Start: %s | Arrival: %s", flights[i].flightNumber, flights[i].origin, flights[i].destination, flights[i].startTime, flights[i].arrivalTime);
    }

    // Search by Airport Code
    printf("Enter Airport Code to Search: ");
    scanf("%s", airportCode);

    printf("Flights for Airport %s: ", airportCode);
    for (i = 0; i < 3; i++)
    {
...
void question15()
{
    ...
    printf("Name: %s Salary: $%.2f Hire Date: %s %d, %d", person1.name, person1.salary, person1.hireDate.month, person1.hireDate.day, person1.hireDate.year);
}
